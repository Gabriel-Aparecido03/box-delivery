...
describe('Make package as returned - E2E', () => {
  ...
  test('[PATCH] package/status/retuned/:id', async () => {
    ...
    const response = await request(app.getHttpServer())
      .patch(`/package/status/returned/${packageOrder.id}`)
    ...
    expect(packageAtDatabase.status).toEqual('RETURNED')
  })
})